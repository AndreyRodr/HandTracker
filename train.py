...
# NOTE: O comando abaixo exige a instalação do 'kagglehub' e a configuração das suas credenciais do Kaggle.
# Se o download falhar, você deve baixar o dataset manualmente e ajustar o caminho DATA_DIR.
try:
    ...
    print(f"[ERRO] Falha ao baixar o dataset: {e}. Certifique-se de que o 'kagglehub' está instalado e configurado.")
    # Fallback para o caso de download manual. Ajuste o caminho!
...
if not X_raw:
    raise ValueError(f"Nenhum arquivo .csv encontrado no diretório {DATA_DIR}. Execute o download manual ou configure o kagglehub.")
